...
<div class="choosing-business-type">
    <div class="container">
        ...
        <div class="custom-tabs" role="tablist" id="myTab">
            ...
            <div class="tab-item" role="tab" tabindex="0" aria-selected="false" aria-controls="select-plan" data-bs-toggle="tab" data-bs-target="#select-plan">
                SELECT PLAN
            </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="income" role="tabpanel" aria-labelledby="income-tab">
                <section class="choosing-business-type_section">
                    ...
                    <div class="select_income_container">
                        ...
                        <div class="income-item" data-index="1">
                            <div class="income-label">
                                <p>Interest</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                        ...
                        <div class="income-item" data-index="2">
                            <div class="income-label">
                                <p>Dividends</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                        ...
                        <div class="income-item" data-index="3">
                            <div class="income-label">
                        ...
                        <div class="income-item" data-index="4">
                            <div class="income-label">
                                <p>Government Pension</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                            <div class="income-icon">
                                <img src="{{ asset('img/image.png') }}" class="img-fluid" alt="image">
                        ...
                        <div class="income-item" data-index="5">
                            <div class="income-label">
                                <p>Capital Gains or Losses</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                            <div class="income-icon">
                                <img src="{{ asset('img/image.png') }}" class="img-fluid" alt="image">
                        ...
                        <div class="income-item hidden" data-index="6">
                            <div class="income-label">
                                <p>Managed Funds</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                        ...
                        <div class="income-item hidden" data-index="7">
                            <div class="income-label">
                        ...
                        <div class="income-item hidden" data-index="8">
                            <div class="income-label">
                                <p>Rent Received</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                        ...
                        <div class="income-item hidden" data-index="9">
                            <div class="income-label">
                        ...
                        <div class="income-item hidden" data-index="10">
                            <div class="income-label">
                                <p>Australian Annuities</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                            <div class="income-icon">
                                <img src="{{ asset('img/image.png') }}" class="img-fluid" alt="image">
                        ...
                        <div class="income-item hidden" data-index="11">
                            <div class="income-label">
                                <p>Superannuation Income Stream</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                            <div class="income-icon">
                                <img src="{{ asset('img/image.png') }}" class="img-fluid" alt="image">
                        ...
                        <div class="income-item hidden" data-index="12">
                            <div class="income-label">
                                <p>Super Lump Sums</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                        ...
                        <div class="income-item hidden" data-index="13">
                            <div class="income-label">
                        ...
                        <div class="income-item hidden" data-index="14">
                            <div class="income-label">
                                <p>Personal Services Income</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                            <div class="income-icon">
                                <img src="{{ asset('img/image.png') }}" class="img-fluid" alt="image">
                        ...
                        <div class="income-item hidden" data-index="15">
                            <div class="income-label">
                                <p>Income / Loss From Business</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                            <div class="income-icon">
                                <img src="{{ asset('img/image.png') }}" class="img-fluid" alt="image">
                        ...
                        <div class="income-item hidden" data-index="16">
                            <div class="income-label">
                                <p>Deferred Business Losses</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                            <div class="income-icon">
                                <img src="{{ asset('img/image.png') }}" class="img-fluid" alt="image">
                        ...
                        <div class="income-item hidden" data-index="17">
                            <div class="income-label">
                        ...
                        <div class="income-item hidden" data-index="18">
                            <div class="income-label">
                                <p>Other Income</p>
                                <img src="{{ asset('img/icons/hr.png') }}" class="img-fluid" alt="hr">
                            </div>
                    ...
                    <div class="text-center">
                        <button class="btn toggle-btn" id="toggleBtn">Show More</button>
                    </div>
                </section>
                <section class="choosing-business-type_section">
                    ...
                    <div class="form-container">
                        ...
                        <div class="d-none" id="form-2">@include('forms.dividends')</div>
                        <div class="d-none" id="form-3">@include('forms.government_allowances')</div>
                        <div class="d-none" id="form-4">@include('forms.government_pension')</div>
                        <div class="d-none" id="form-5">@include('forms.capital_gains')</div>
                        <div class="d-none" id="form-6">@include('forms.managed_funds')</div>
                        <div class="d-none" id="form-7">@include('forms.termination_payments')</div>
                        <div class="d-none" id="form-8">@include('forms.rent')</div>
                        <div class="d-none" id="form-9">@include('forms.partnerships')</div>
                        <div class="d-none" id="form-10">@include('forms.annuities')</div>
                        <div class="d-none" id="form-11">@include('forms.superannuation')</div>
                        <div class="d-none" id="form-12">@include('forms.super_lump_sums')</div>
                        <div class="d-none" id="form-13">@include('forms.ess')</div>
                        <div class="d-none" id="form-14">@include('forms.personal_services')</div>
                        <div class="d-none" id="form-15">@include('forms.business_income')</div>
                        <div class="d-none" id="form-16">@include('forms.business_losses')</div>
                        <div class="d-none" id="form-17">@include('forms.foreign_income')</div>
                        <div class="d-none" id="form-18">@include('forms.other_income')</div>
                    </div>
                </section>
            </div>
            <div class="tab-pane fade" id="select-plan" role="tabpanel" aria-labelledby="select-plan-tab">
                <!-- Содержимое Select Plan -->
                <h2 class="fw-bold text-info">Select your plan</h2>
